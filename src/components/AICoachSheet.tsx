...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '700', color: COLORS.textPrimary, fontFamily: 'Outfit' },
  close: { fontSize: 20, color: COLORS.textSecondary, padding: 4 },
  chat: { flex: 1 },
  empty: { alignItems: 'center', paddingVertical: 40 },
  emptyIcon: { fontSize: 48, marginBottom: 16 },
  emptyTitle: { fontSize: 18, fontWeight: '600', color: COLORS.textPrimary, fontFamily: 'Outfit', marginBottom: 12 },
