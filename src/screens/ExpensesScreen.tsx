...
const styles = StyleSheet.create({
  ...
  total: { fontSize: 20, fontWeight: '700', color: COLORS.primary, fontFamily: 'Outfit' },
  ...
  summaryAmount: { fontSize: 32, fontWeight: '700', color: COLORS.primary, fontFamily: 'Outfit', marginTop: 4 },
